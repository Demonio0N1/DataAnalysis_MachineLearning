...
# state_dict = torch.load("autoencoder_active_matterwnon.pth", map_location=device, weights_only=True)
...
plt.legend()
plt.tight_layout()
plt.savefig("model_0.png", dpi=300)
plt.show()

# Guardado final
torch.save(model.state_dict(), "model_0v2.pth")
print("✅ Modelo guardado como 'model_0v2.pth'")